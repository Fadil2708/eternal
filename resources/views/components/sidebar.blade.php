...
<aside class="sidebar" :class="sidebarOpen ? 'open' : ''"
    ...
    <div class="sidebar-header">
        <a href="{{ route('dashboard') }}" class="sidebar-logo">
            <picture><source srcset="{{ asset('images/TLK_BIG.webp') }}" type="image/webp"><img src="{{ asset('images/TLK_BIG.webp') }}" alt="Eternal Internship" class="sidebar-logo-img"></picture>
        </a>
    </div>
