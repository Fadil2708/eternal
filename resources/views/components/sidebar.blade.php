...
<aside class="sidebar" :class="sidebarOpen ? 'open' : ''"
    ...
    <div class="sidebar-header">
        <a href="{{ route('dashboard') }}" class="sidebar-logo">
            <picture><source srcset="{{ asset('images/LogoEternalUtama.webp') }}" type="image/webp"><img src="{{ asset('images/LogoEternalUtama.webp') }}" alt="Eternal Internship" class="sidebar-logo-img"></picture>
        </a>
    </div>
