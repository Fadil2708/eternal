...
use App\Http\Controllers\Intern\TestimonialController;
...
Route::prefix('v1')->name('api.')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'throttle:60,1'])->group(function () {
        ...
        Route::post('vacancies', [VacancyController::class, 'store'])->middleware('role:admin')->name('vacancies.store');
        Route::get('vacancies/{vacancy}', [VacancyController::class, 'show'])->name('vacancies.show');
        Route::put('vacancies/{vacancy}', [VacancyController::class, 'update'])->middleware('role:admin')->name('vacancies.update');
        Route::delete('vacancies/{vacancy}', [VacancyController::class, 'destroy'])->middleware('role:admin')->name('vacancies.destroy');
        Route::patch('vacancies/{vacancy}/status', [VacancyController::class, 'updateStatus'])->middleware('role:admin')->name('vacancies.status');
        ...
        Route::get('applications/{application}', [ApplicationController::class, 'show'])->middleware('role:admin,intern')->name('applications.show');
        ...
        // Logbooks
        Route::get('internships/{internship}/logbooks', [LogbookController::class, 'index'])->name('logbooks.index');
        ...
        Route::get('internships/{internship}/reports', [FinalReportController::class, 'show'])->name('reports.show');
        ...
        Route::get('internships/{internship}/evaluations', [EvaluationController::class, 'show'])->name('evaluations.show');
        ...
        Route::get('internships/{internship}/certificates', [CertificateController::class, 'show'])->name('certificates.show');
        ...
        // Testimonials
        Route::post('internships/{internship}/testimonials', [TestimonialController::class, 'store'])->middleware('role:intern')->name('testimonials.store');
    ...
    Route::get('verify/{token}', [CertificateVerifyController::class, 'verify'])->name('verify');

    // ─── Admin Aggregate Lists ───────────────────────────
    Route::middleware(['auth:sanctum', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
        Route::get('logbooks', [LogbookController::class, 'adminIndex'])->name('logbooks.index');
        Route::get('reports', [FinalReportController::class, 'adminIndex'])->name('reports.index');
